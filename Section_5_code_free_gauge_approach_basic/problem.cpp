...
namespace myslam {
    namespace backend {
        ...
        void Problem::Output_verticies_and_delta_x_() {
            for (auto vertex : verticies_) {
                cout << "vertex Id = " << vertex.second->Id() << ": " << vertex.second->Parameters().transpose() << endl;
            }
            cout << "delta_x_ = " << delta_x_.transpose() << endl;
        }
        ...
        bool Problem::Solve(int iterations) {
            ...
            cout << "\n----- before iter -----" << endl;
            cout << "\n初始的x 和 Δx:" << endl;
            Output_verticies_and_delta_x_();
            cout << "\n初始的loss = " << currentChi_ << "; 阻尼因子 = " << currentLambda_ << endl;
            ////////////////////////////////////////////////////////
            ...
            // LM 初始化
            ComputeLambdaInitLM();
            cout << "\nafter ComputeLambdaInitLM, loss = " << currentChi_ << "; 阻尼因子 = " << currentLambda_ << endl;
            // LM 算法迭代求解
            bool stop = false;
            int iter = 0;
            while (!stop && (iter < iterations)) {
                cout << "\n----- iter " << iter << " -----" << endl;
                //std::cout << "\niter: " << iter << " , chi= " << currentChi_ << " , currentLambda_ = " << currentLambda_ << std::endl;
                ...
                while (!oneStepSuccess)  // 不断尝试 Lambda, 直到成功迭代一步
                {
                    ...
                    // 第四步，解线性方程
                    SolveLinearSystem(); // 包含了AddLambdatoHessianLM 的功能
                    ////////////////////////////////////////////////////////
                    cout << "\nx 和 Δx after SolveLinearSystem:" << endl;
                    Output_verticies_and_delta_x_();
                    cout << "SolveLinearSystem 只更新Δx, x不变" << endl;
                    ////////////////////////////////////////////////////////
                    // 
                    ...
                    UpdateStates();
                    ////////////////////////////////////////////////////////
                    cout << "\nx 和 Δx after UpdateStates:" << endl;
                    Output_verticies_and_delta_x_();
                    cout << "UpdateStates 只更新x, Δx不变" << endl;
                    ////////////////////////////////////////////////////////

                    // 判断当前步是否可行以及 LM 的 lambda 怎么更新
                    oneStepSuccess = IsGoodStepInLM();
                    cout << "\nafter IsGoodStepInLM, loss = " << currentChi_ << "; 阻尼因子 = " << currentLambda_ << endl;
        ...
        //                stop = (b_max <= 1e-12);
                        false_cnt = 0;
                        cout << "\noneStepSuccess = True; false_cnt = " << false_cnt << endl;
                    }
                    else {
                        false_cnt++;
                        cout << "\noneStepSuccess = False; false_cnt = " << false_cnt << endl;
            ...
            {
                cout << "\nEdge -> Id() = " << edge.second->Id() << endl;                  // 边id
                //cout << "Edge->NumVertices() = " << edge.second->NumVertices() << endl;    // 边关联的顶点数量

                std::vector<std::shared_ptr<Vertex>> vector_vertex = edge.second->Verticies();
                std::vector<MatXX> vector_jacobians = edge.second->Jacobians();

                for (size_t ii = 0; ii < vector_vertex.size(); ii++)
                {
                    cout << "Id = " << vector_vertex[ii]->Id() << "; Jacobians =\n" << vector_jacobians[ii] << endl;
                }
                cout << "Edge->Residual():\n" << edge.second->Residual() << endl;          // 残差
                cout << "Edge->Information():\n" << edge.second->Information() << endl;    // 信息矩阵,单目BA的信息矩阵为单位矩阵
                //cout << "Edge->Observation(): " << edge.second->Observation() << endl;     // 观测信息
                cout << "Edge->OrderingId(): " << edge.second->OrderingId() << endl;
                cout << "Edge->TypeInfo(): " << edge.second->TypeInfo() << endl;
            }
        ...
        void Problem::SetOrdering() {
            ...
            ////////////////////////////////////////////////////////
            /*cout << "\nSetOrdering before loop ..." << endl;
            for (auto vertex : verticies_) {
                cout << "vertex Id = " << vertex.second->Id() << ", TypeInfo = " << vertex.second->TypeInfo() << ", OrderingId before SetOrdering and AddOrderingSLAM = " << vertex.second->OrderingId() << endl;
            ...
            /*cout << endl;
            for (auto vertex : verticies_) {
                cout << "vertex Id = " << vertex.second->Id() << ", TypeInfo = " << vertex.second->TypeInfo() << ", OrderingId after AddOrderingSLAM = " << vertex.second->OrderingId() << endl;
            }*/
            ////////////////////////////////////////////////////////
            ...
            /*cout << endl;
            for (auto vertex : verticies_) {
                cout << "vertex Id = " << vertex.second->Id() << ", TypeInfo = " << vertex.second->TypeInfo() << ", OrderingId after SetOrdering = " << vertex.second->OrderingId() << endl;
            }
            cout << "\nordering_generic = " << ordering_generic_ << ", ordering_poses = " << ordering_poses_ << ", ordering_landmarks = " << ordering_landmarks_  << endl;*/
            ////////////////////////////////////////////////////////
        ...
        void Problem::MakeHessian() {
            ...
            for (auto& edge : edges_) {
                ...
                edge.second->ComputeResidual();  // 更新H
                edge.second->ComputeJacobians(); // 更新b
                ...
                for (size_t i = 0; i < verticies.size(); ++i) {
                    ...
                    for (size_t j = i; j < verticies.size(); ++j) {
                        ...
                        ////////////////////////////////////////////////////////
                        /*cout << "\nedge Id = " << edge.second->Id() << "; vertex_i Id = " << v_i->Id() << "; OrderingId = " << v_i->OrderingId() << "; vertex_j Id = " << v_j->Id() << "; OrderingId = " << v_j->OrderingId() << endl;
                        cout << H << endl;*/
                        ////////////////////////////////////////////////////////
                    }
            ...
            cout << "delta_x_ = " << delta_x_.transpose() << endl;
            cout << "after MakeHessian, loss = " << currentChi_ << "; 阻尼因子 = " << currentLambda_ << endl;
            cout << "new loss = " << tempChi << endl;
        }
